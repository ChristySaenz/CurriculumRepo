...
# Path to collect data from the Resources folder stored in graduation_csv


# Define the print_percentages function and have it accept the 'state_data' as its sole parameter
